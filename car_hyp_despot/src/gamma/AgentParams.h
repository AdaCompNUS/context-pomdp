...
struct AgentParams{
	...
	static const AgentParams& getDefaultAgentParam(std::string tag){
		...
		static auto create_lookup = []() { //lambda function
			...
			float ped_timeHorizonObst = 0.5f;
			...
			float scooter_timeHorizonObst = 0.5f;
			...
			float car_timeHorizonObst = 0.5f;
			...
			float van_timeHorizonObst = 0.5f;
			...
			float bus_timeHorizonObst = 0.5f;
			...
			float jeep_timeHorizonObst = 0.5f;
			...
			float bicycle_timeHorizonObst = 0.5f;
			...
			float electric_tricycle_timeHorizonObst = 0.5f;
			...
			float gyro_scooter_timeHorizonObst = 0.5f;
