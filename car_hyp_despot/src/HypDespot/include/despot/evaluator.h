...
protected:
	...
	std::vector<bool> round_reach_terminal;
...
public:
	...
	virtual double EndRound(bool terminal=false) = 0;// Return total undiscounted reward for this round.
	...
	double AverageActionFrequency(int action) const;
	/* GPU despot */
...
public:
	...
	void InitRound();
	double EndRound(bool terminal=false);
