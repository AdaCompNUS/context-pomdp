...
do
	...
	#timeout 1 roslaunch --wait crowd_pomdp_planner is_despot.launch goal_x:=$goal_x goal_y:=$goal_y obstacle_file_name:=$obstacle_file goal_file_name:=$goal_file &> result/dummy
	...
	cd ~/workspace/catkin_ws/src/crowd_pomdp_planner/src
	...
	sleep 1
	roslaunch crowd_pomdp_planner ped_sim.launch obstacle_file_name:=$obstacle_file goal_file_name:=$goal_file &> $root_path/result/$subfolder'_debug'/ped_sim_log_single'_'$i'_'$j &
	...
	rosrun crowd_pomdp_planner vel_publisher &
	...
	# timeout 120 roslaunch --wait crowd_pomdp_planner is_despot.launch goal_x:=$goal_x goal_y:=$goal_y obstacle_file_name:=$obstacle_file goal_file_name:=$goal_file &> $root_path/result/$subfolder/$problem_flag'_goal_'$goal_flag'_sample-'$run'-'$i'-'$j.txt	
	# sleep 7
