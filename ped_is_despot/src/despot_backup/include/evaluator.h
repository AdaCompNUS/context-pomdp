...
protected:
	...
	vector< vector<double> > round_features_; //the features in one round
	vector<double> round_dis_rewards_; //the discounted rewards till (i-1)-th step in one round; i is the index of the elems in round_dis_rewards
	vector<double> round_undis_rewards_; //the undiscounted rewards till (i-1)-th step in one round; i is the index of the elems in round_dis_rewards
	vector<double> round_dis_rewards_end_;
	vector<double> round_undis_rewards_end_;
