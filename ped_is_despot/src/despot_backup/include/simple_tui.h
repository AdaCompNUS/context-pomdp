...
const option::Descriptor usage[] = {
  ...
  { E_UNNORM, 0, "", "unnormalized", option::Arg::None,
    "  \t--unnormalized \tUse UIS-DESPOT if unnormalized is set." },
  { E_NO_IMPORTANCE_SAMPLING, 0, "", "no-importance-sampling", option::Arg::None,
    "  \t--no-importance-sampling \tDon't use importance sampling if no-importance-sampling is set." },
  { E_COLLECT_DATA, 0, "", "collect-data", option::Arg::None,
