...
WorldModel::WorldModel(): freq(ModelParams::control_freq),
    ...
    if(ModelParams::DRIVING_PLACE==0)
        goals = {// for the map: utown_small_fill:
    ...
    else if(ModelParams::DRIVING_PLACE==1)    
        goals = {//for the map: my_create:
            COORD(5.38, 1.856),  //green
            COORD(13.737, 2.947),  //red
            COORD(6.544, 10.930),  //blue
            COORD(10.651,12.322),  //sky blue
            COORD(5.940,19.330),  //yellow
            COORD(11.324,18.889),  //brown
            COORD(-1,-1)   //pink
        };
    else if(ModelParams::DRIVING_PLACE==3)
        goals = {//for the map: passage:
            COORD(-9.42, 9.95),  //green, one side of the passage
            //COORD(-14.10, 6.70),  //red, middle of the passage
            COORD(-23.00, 7.41),  //red, the other side of the passage
            //COORD(-16.43, 6.63),  //red, higher middle
            COORD(-1,-1)   //blue
        };
    else if(ModelParams::DRIVING_PLACE==4)
        goals = {//for the map: passage_1:
            COORD(30.27, 6.06),  //green, one side of the passage
            //COORD(-14.10, 6.70),  //red, middle of the passage
            COORD(15.39, 10.89),  //red, the other side of the passage
            //COORD(-16.43, 6.63),  //red, higher middle
            COORD(-1,-1)   //blue
        };
    else if(ModelParams::DRIVING_PLACE==5)
        goals = {//for the map: passage_2:
            COORD(12.20,-7.60),  //green, one side of the passage
            //COORD(-14.10, 6.70),  //red, middle of the passage
            COORD(27.92, -11.31),  //red, the other side of the passage
            //COORD(-16.43, 6.63),  //red, higher middle
            COORD(-1,-1)   //blue
        };
    else if(ModelParams::DRIVING_PLACE==6)
        goals = {//for the map: create, two goals for inital belief:
            COORD(15.72,45.48),  //green, inside tree
            COORD(22.91, 44.78),  //red, outside tree
            //COORD(-16.43, 6.63),  //red, higher middle
            COORD(-1,-1)   //blue
        };
    else if(ModelParams::DRIVING_PLACE==7)
      //  goals = {//for the map: create, two goals for inital belief:
       //     COORD(8.44,21.48),  //green, inside tree
          //  COORD(15.72, 15.29),  //red, outside tree
            //COORD(-16.43, 6.63),  //red, higher middle
          //  COORD(-1,-1)   //blue

        goals = {//for the map: create, two goals for inital belief:
            COORD(10.21,20.62),  //green, cheers
            COORD(33.16, 25.84),  //red, garage
            //COORD(-16.43, 6.63),  //red, higher middle
            COORD(-1,-1)   //blue

        };
    else if(ModelParams::DRIVING_PLACE==8)
        goals = {//for the map: create, two goals for inital belief: indoor
            COORD(-10.48,7.72),  //green, inside tree
            COORD(-11.85, 10.21),  //red, outside tree
            //COORD(-16.43, 6.63),  //red, higher middle
            COORD(-1,-1)   //blue
        };
	/*
