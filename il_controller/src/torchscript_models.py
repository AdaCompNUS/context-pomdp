...
GPPN_l_i, GPPN_l_h, GPPN_k, GPPN_f, output_channels_VIN, vanilla_resnet, resnet_width, no_ped, no_car = \
...
def set_globals():
    global GPPN_l_i, GPPN_l_h, GPPN_k, GPPN_f, output_channels_VIN, vanilla_resnet, resnet_width, no_ped, no_car
    global resblock_in_layers, disable_bn_in_resnet, num_steering_bins, imsize
    GPPN_l_i = global_config.default_li
    GPPN_l_h = global_config.default_lh
    GPPN_k = global_config.num_iterations
    ...
    no_ped = global_config.num_agents_in_NN
...
class PolicyValueNet(torch.jit.ScriptModule):
    ...
    def __init__(self):
        ...
        self.imsize = global_config.imsize
        self.head_mode = global_config.head_mode
        ...
        self.resblock_in_layers = global_config.resblock_in_layers

        self.car_VIN = GPPN.GPPN(l_i=GPPN_l_i, l_h=GPPN_l_h, k=GPPN_k, f=GPPN_f)
        self.output_channels_VIN = output_channels_VIN
        ...
        self.num_resnet_out_features = global_config.resnet_width
